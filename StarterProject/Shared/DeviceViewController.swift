...
class DeviceViewController: UIViewController {
    ...
    func loadSounds(env: Environment){
        ...
        case "Fireside":
            ...
            playSoundsController.updatePosition(index: 1, position: AVAudio3DPoint(x: -35, y: 0, z: 35))
            playSoundsController.updatePosition(index: 2, position: AVAudio3DPoint(x: 35, y: 0, z: 35))
        case "Cello":
